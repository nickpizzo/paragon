...
ProductTour.propTypes = {
  tours: PropTypes.arrayOf(PropTypes.shape({
    ...
    checkpoints: PropTypes.arrayOf(PropTypes.shape({
      ...
      /** A function that would be triggered when triggering the `onClick` event of the advance
       * button for the given Checkpoint. */
      onAdvance: PropTypes.func,
      /** A function that would be triggered when triggering the `onClick` event of the dismiss
