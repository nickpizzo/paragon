...
describe('Checkpoint', () => {
  ...
  describe('second Checkpoint in Tour', () => {
    ...
    it('renders correct active breadcrumb', () => {
      ...
      expect(breadcrumbs[0].classList).toContain('border-primary');
      expect(breadcrumbs[1].classList).toContain('bg-primary');
      expect(breadcrumbs[2].classList).toContain('border-primary');
      expect(breadcrumbs[3].classList).toContain('border-primary');
      expect(breadcrumbs[4].classList).toContain('border-primary');
    });
